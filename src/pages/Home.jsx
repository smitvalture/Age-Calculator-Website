          ...
          <form onSubmit={handleSubmit} className='w-[calc(100vw-110px)] md:w-[500px] lg:w-[600px] h-fit flex flex-col gap-14 md:gap-10'>
            <div className='w-5/6 md:w-3/4 flex justify-between gap-5'>
              <div className='flex flex-col gap-1 w-[35%] md:w-[30%]'>
                ...
                {error.day && <p className='text-red-400 text-[11px] italic'>{error.day}</p>}
              ...
              <div className='flex flex-col gap-1 w-[35%] md:w-[30%]'>
                ...
                {error.month && <p className='text-red-400 text-[11px] italic'>{error.month}</p>}
              ...
              <div className='flex flex-col gap-1 w-[35%] md:w-[30%]'>
                ...
                {error.year && <p className='text-red-400 text-[11px] italic'>{error.year}</p>}

              </div>
            </div>

            <div className='relative flex justify-center w-full h-[2px] bg-gray-300'>
              <button onClick={handleErrors} type="submit" disabled={error.day || error.month || error.year} className='absolute md:right-0 -top-7 md:-top-10 w-14 h-14 md:w-20 md:h-20 p-3 md:p-4 duration-300 bg-[#7d50f5] hover:bg-black rounded-full hover:shadow-inner shadow-white disabled:bg-gray-500 disabled:cursor-not-allowed'>
